...
public class ComplexLockBasedTests extends QueryResponderTests {
    ...
    public void test_None() {
        ComplexLockBased s = new ComplexLockBased(data, 100, 500);
        System.out.println(s.getPopulation(1, 1, 4, 4));
//        System.out.println(s.getPopulation(3, 1, 4, 4));
//        int n = s.getPopulation(1, 1, 4, 4);
//        int j = s.getPopulation(3, 1, 4, 4);
